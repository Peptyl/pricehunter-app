...
- **Retailer Aggregation:** Price comparisons from 10+ fragrance retailers

### Service Availability
- We strive for 99.9% uptime but do not guarantee uninterrupted access
- Price data is updated periodically and may not reflect real-time changes
...
- **Scrape or Crawl:** Use automated tools to extract data from our Service
- **Reverse Engineer:** Attempt to decompile, reverse engineer, or disassemble our code
- **API Abuse:** Make excessive API calls that could harm our infrastructure
- **Data Mining:** Extract price data for commercial purposes without authorization
- **Circumvent Security:** Bypass any security measures or access restrictions
- **Impersonation:** Pretend to be another user or entity
- **Malicious Use:** Introduce viruses, worms, or other harmful code
- **Interference:** Disrupt the Service or servers/networks connected to it

### Scraping Specifically Prohibited
You may NOT:
...
### Your Content
- You retain ownership of products you track and wishlist items
- You grant us a license to store and process this data to provide the Service

## 6. Third-Party Links

Our Service contains links to third-party websites (retailers). We:
...
- Accuracy of price data (prices may change without our immediate knowledge)
- Uninterrupted or error-free service
- Fitness for a particular purpose
- Non-infringement

Price data is provided for informational purposes only. Always verify prices on the retailer's website before purchasing.
...
- We are not responsible for:
  - Price discrepancies between our data and retailer websites
  - Missed deals due to notification delays
  - Actions taken based on price information we provide
  - Loss of data or unauthorized access beyond our reasonable control
...
These Terms shall be governed by and construed in accordance with the laws of **England and Wales**, United Kingdom, without regard to conflict of law provisions.

### Dispute Resolution
- Any disputes shall first be attempted to be resolved through good-faith negotiation
- If unresolved, disputes shall be submitted to the exclusive jurisdiction of the courts of England and Wales
